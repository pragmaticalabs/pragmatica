...
public final class RestoredRaftState {
    ...
    @Nonnull
    public RaftEndpointPersistentState localEndpointPersistentState() {
        return localEndpointPersistentState;
    }

    @Nonnull
    public RaftGroupMembersView initialGroupMembers() {
        return initialGroupMembers;
    }

    @Nonnull
    public RaftTermPersistentState termPersistentState() {
