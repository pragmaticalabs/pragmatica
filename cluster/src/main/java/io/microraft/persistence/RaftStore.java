...
public interface RaftStore {
     ...
     * {@link RaftConfig#commitCountToTakeSnapshot()}. For instance, if it is
     ...
     * difference, controlled by {@link RaftConfig#maxPendingLogEntryCount()}.
     ...
     * {@link RaftConfig#maxPendingLogEntryCount()} + 1. Say that it is 5 and the
    ...
    RestoredRaftState toRestoredRaftState();
}
