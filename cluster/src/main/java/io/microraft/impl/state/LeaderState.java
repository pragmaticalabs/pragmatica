...
public final class LeaderState {
     ...
     */
    public FollowerState followerState(RaftEndpoint follower) {
        var followerState = followerStates.get(follower);
        assert followerState != null : "Unknown follower " + follower;
        return followerState;
    }

    public FollowerState followerStateOrNull(RaftEndpoint follower) {
     ...
     */
    public Map<RaftEndpoint, FollowerState> followerStates() {
