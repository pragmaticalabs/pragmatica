...
public final class RaftNodeReportImpl implements RaftNodeReport {
    ...
    @Nonnull
    @Override
    public RaftNodeReportReason reason() {
        return reason;
    }
    ...
    @Nonnull
    @Override
    public RaftGroupMembers committedMembers() {
        return committedMembers;
    }

    @Nonnull
    @Override
    public RaftGroupMembers effectiveMembers() {
    ...
    @Nonnull
    @Override
    public RaftTerm term() {
        return term;
    }

    @Nonnull
    @Override
    public RaftLogStats log() {
        return log;
    }

    @Nonnull
    @Override
    public Map<RaftEndpoint, Long> heartbeatTimestamps() {
        return heartbeatTimestamps;
    }

    @Nonnull
    @Override
    public Optional<Long> quorumHeartbeatTimestamp() {
        return quorumHeartbeatTimestamp;
    }

    @Nonnull
    @Override
    public Optional<Long> leaderHeartbeatTimestamp() {
