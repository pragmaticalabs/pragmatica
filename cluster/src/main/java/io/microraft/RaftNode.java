...
public interface RaftNode {
    ...
    void setStatus(RaftNodeStatus newStatus);
     ...
     */
    @Nonnull
    RaftGroupMembers initialMembers();
     ...
     */
    @Nonnull
    RaftGroupMembers committedMembers();
     ...
     */
    @Nonnull
    RaftGroupMembers effectiveMembers();
     ...
     * index can be accessed via {@link #committedMembers()}.
     * <p>
     ...
     * has timed out w.r.t {@link RaftConfig#leaderHeartbeatTimeoutSecs()}.
     *
     * @param endpoint
     ...
     */
    @Nonnull
    CompletableFuture<Ordered<RaftNodeReport>> report();
    ...
    RaftException newNotLeaderException();

    RuntimeException newNotRunningException();

    RaftException newLaggingCommitIndexException(long minCommitIndex);
    ...
    interface RaftNodeBuilder {
         ...
         * scheduled tasks.
         * <p>
         * If not set, {@link RaftNodeExecutor.DefaultRaftNodeExecutor} is used.
         *
         * @param executor
         ...
         *
         * @see RaftNodeExecutor
         * @see RaftNodeExecutor.DefaultRaftNodeExecutor
         */
        @Nonnull
