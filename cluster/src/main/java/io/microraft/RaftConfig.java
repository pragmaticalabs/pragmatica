 ...
 *
 * @param leaderElectionTimeoutMillis           Duration of leader election rounds in milliseconds. If a candidate cannot win
 ...
 * @param leaderHeartbeatTimeoutSecs            Duration in seconds for a follower to decide on failure of the current leader
 ...
 *                                              leader, MicroRaft uses two different parameters for these cases.
 *                                              <p>
 ...
 * @param leaderHeartbeatPeriodSecs             Duration in seconds for a Raft leader node to send periodic heartbeat
 ...
 * @param maxPendingLogEntryCount               Maximum number of pending log entries in the leader's Raft log before
 ...
 *                                              clients.
 * @param appendEntriesRequestBatchSize         In MicroRaft, a leader Raft node sends log entries to its followers in
 ...
 * @param commitCountToTakeSnapshot             Number of new commits to initiate a new snapshot after the last snapshot
 ...
 * @param transferSnapshotsFromFollowersEnabled If enabled, when a Raft follower falls far behind the Raft leader and needs
 ...
 *                                              in MicroRaft snapshots are taken at the same log indices on all Raft nodes.
 * @param raftNodeReportPublishPeriodSecs       Denotes how frequently a Raft node publishes a report of its internal Raft
 *                                              state. {@link RaftNodeReport} objects can be used for monitoring a running
 *                                              Raft group.
 */
public record RaftConfig(long leaderElectionTimeoutMillis, long leaderHeartbeatPeriodSecs,
     ...
     *
     * @param leaderElectionTimeoutMillis           duration of leader election rounds in milliseconds
     * @param leaderHeartbeatPeriodSecs             duration in seconds for a Raft leader node to send periodic
     *                                              heartbeat requests to its followers in order to denote its
     *                                              liveliness
     * @param leaderHeartbeatTimeoutSecs            duration in seconds for a follower to decide on failure of the
     *                                              current leader and start a new leader election round
     * @param appendEntriesRequestBatchSize         maximum number of Raft log entries that can be sent as a batch in
     *                                              a single append entries request
     * @param commitCountToTakeSnapshot             number of new commits to initiate a new snapshot after the last
     *                                              snapshot taken
     * @param maxPendingLogEntryCount               maximum number of pending log entries in the leader's Raft log
     *                                              before temporarily rejecting new requests of clients
     * @param transferSnapshotsFromFollowersEnabled enable / disable parallel snapshot transfer from followers
     * @param raftNodeReportPublishPeriodSecs       how frequently a Raft node publishes a report of its internal Raft
     *                                              state
     */
    public RaftConfig {
    }
     ...
     */
    @Override
    public long leaderElectionTimeoutMillis() {
     ...
     */
    @Override
    public long leaderHeartbeatTimeoutSecs() {
     ...
     */
    @Override
    public long leaderHeartbeatPeriodSecs() {
     ...
     */
    @Override
    public int maxPendingLogEntryCount() {
     ...
     */
    @Override
    public int appendEntriesRequestBatchSize() {
     ...
     */
    @Override
    public int commitCountToTakeSnapshot() {
     ...
     */
    @Override
    public boolean transferSnapshotsFromFollowersEnabled() {
     ...
     */
    @Override
    public int raftNodeReportPublishPeriodSecs() {
    ...
    public static final class RaftConfigBuilder {
        ...
        /**
         * @param leaderElectionTimeoutMillis the leader election timeout in milliseconds value to set
         *
        ...
        /**
         * @param leaderHeartbeatTimeoutSecs the leader heartbeat timeout in seconds value to set
         *
         * @return the builder object for fluent calls
        ...
        /**
         * @param leaderHeartbeatPeriodSecs the leader heartbeat period in seconds value to set
         *
         * @return the builder object for fluent calls
        ...
        /**
         * @param appendEntriesRequestBatchSize the append entries request batch size value to set
         *
         * @return the builder object for fluent calls
        ...
        /**
         * @param commitCountToTakeSnapshot the commit count to take snapshot value to set
         *
         * @return the builder object for fluent calls
        ...
        /**
         * @param maxPendingLogEntryCount the max pending log entry count value to set
         *
         * @return the builder object for fluent calls
        ...
        /**
         * @param transferSnapshotsFromFollowersEnabled the transfer snapshot from followers value to set
         *
         * @return the builder object for fluent calls
         * @see #transferSnapshotsFromFollowersEnabled
         */
        ...
        /**
         * @param raftNodeReportPublishPeriodSecs the raft node report publish period value to set
         *
         * @return the builder object for fluent calls
         * @see #raftNodeReportPublishPeriodSecs
         */
