...
public class RestoreCrashedRaftNodeTest {
    ...
    public void testRestoreCrashedRaftNode() {
        ...
        RaftNode crashedFollower = group.anyNodeExcept(leader.localEndpoint());
        ...
        RestoredRaftState restoredState = RaftTestUtils.restoredState(crashedFollower);
        RaftStore raftStore = RaftTestUtils.raftStore(crashedFollower);
        group.terminateNode(crashedFollower.localEndpoint());
        RaftNode restoredFollower = group.restoreNode(restoredState, raftStore);
