...
public class RaftLogTest {
    ...
    public void setUp() {
        ...
        groupMembersView = new DefaultRaftGroupMembersViewOrBuilder()
                .setLogIndex(0)
    ...
    public void test_appendEntries_withHigherTerms() {
        List<LogEntry> entries = List.of(
                new DefaultLogEntryOrBuilder().setTerm(1).setIndex(1).build(),
    ...
    public void test_appendEntriesAfterSnapshot_withSameTerm() {
        List<LogEntry> entries = List.of(
                ...
                new DefaultLogEntryOrBuilder().setTerm(1).setIndex(3).build());
        log.appendEntries(entries);
        log.setSnapshot(new DefaultSnapshotEntryOrBuilder()
                .setTerm(1)
                .setIndex(3)
    ...
    public void setSnapshotAtLastLogIndex_forSingleEntryLog() {
        ...
        SnapshotChunk snapshotChunk = new DefaultSnapshotChunkOrBuilder()
                .setTerm(1)
                .setIndex(1)
        ...
        log.setSnapshot(new DefaultSnapshotEntryOrBuilder()
                .setTerm(1)
                .setIndex(1)
                .setSnapshotChunks(List.of(snapshotChunk))
                .setGroupMembersView(groupMembersView)
                .build());
    ...
    public void setSnapshot() {
        ...
        int truncated = log.setSnapshot(new DefaultSnapshotEntryOrBuilder()
                .setTerm(1)
                .setIndex(3)
                .setGroupMembersView(groupMembersView)
                .build());
    ...
    public void setSnapshot_multipleTimes() {
        ...
        SnapshotChunk snapshotChunk = new DefaultSnapshotChunkOrBuilder()
                ...
                .setGroupMembersView(groupMembersView)
                .build();
        truncated = log.setSnapshot(new DefaultSnapshotEntryOrBuilder()
                .setTerm(1)
                .setIndex(4)
                .setSnapshotChunks(List.of(snapshotChunk))
                .setGroupMembersView(groupMembersView)
