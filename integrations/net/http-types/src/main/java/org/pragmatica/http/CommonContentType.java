...
/// can be created via [ContentType#contentType(String, ContentCategory)].
public enum CommonContentType implements ContentType {
    ...
    TEXT_CSV("text/csv; charset=UTF-8", ContentCategory.TEXT),
    TEXT_EVENT_STREAM("text/event-stream", ContentCategory.TEXT),
    ...
    APPLICATION_YAML("application/yaml; charset=UTF-8", ContentCategory.TEXT),
    ...
    APPLICATION_FORM_URLENCODED("application/x-www-form-urlencoded", ContentCategory.FORM_URLENCODED),
    MULTIPART_FORM_DATA("multipart/form-data", ContentCategory.MULTIPART),
