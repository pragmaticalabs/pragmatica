    ...
    private void onPeerConnected(QuicPeerConnection connection, NodeRole peerRole, NodeAddress peerAddress, Map<String, String> peerLabels, boolean clientInitiated) {
        ...
        switch (outcome.result()) {
            ...
            case PeerState.AttachResult.REPLACED -> {
                // The new connection supersedes the incumbent — either a SAME-initiator
                // re-handshake retiring a (possibly-zombie) link, or a different initiator that
                // won the deterministic tiebreak. Close the displaced (losing) link in
