...
public sealed interface KVStoreNotification<K extends StructuredKey> extends StateMachineNotification<KVCommand<K>> {
    ...
    ///
    ///
    /// Due to Java type erasure, `ValuePut<AetherKey, AetherValue>` and
    /// `ValuePut<LeaderKey, LeaderValue>` are the same class at runtime.
    ...
    ///
    ///
    /// Returns raw Consumer type to match MessageRouter.Entry.route() signature.
    ///
