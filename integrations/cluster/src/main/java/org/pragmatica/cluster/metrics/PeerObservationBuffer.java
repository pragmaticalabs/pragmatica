...
public interface PeerObservationBuffer {
    ...
    PeerObservationBuffer NOOP = new PeerObservationBuffer() {
        @Contract @Override public void pushHealth(PeerHealthObservation observation) {}
        @Contract @Override public void pushConnectivity(PeerConnectivityObservation observation) {}
        @Override public List<PeerHealthObservation> drainHealth() {return List.of();}
        @Override public List<PeerConnectivityObservation> drainConnectivity() {return List.of();}
    };

    @Contract void pushHealth(PeerHealthObservation observation);
    @Contract void pushConnectivity(PeerConnectivityObservation observation);
