...
public interface FsmObserver<S, E> {
    ...
    FsmObserver NOOP = new FsmObserver() {
        @Override
        @Contract
        public void onTransition(FsmTags tags, Object from, Object to) {}

        @Override
        @Contract
        public void onCasLost(FsmTags tags, Object expected, Object actual) {}

        @Override
        @Contract
        public void onEventIgnored(FsmTags tags, Object state, Object event) {}

        @Override
        @Contract
        public void onHandled(FsmTags tags, Object state, Object event) {}
    };
