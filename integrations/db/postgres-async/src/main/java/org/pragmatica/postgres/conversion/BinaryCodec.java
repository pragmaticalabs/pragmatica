...
public sealed interface BinaryCodec<T> {
    ...
    record Int2Codec() implements BinaryCodec<Short> {
        ...
        @Override
        public void encode(Short value, ByteBuffer buffer) {
            buffer.putShort(value);
        }

        @Override
        public int estimateSize(Short value) {
            return 2;
        }
    }
    ...
    record Int4Codec() implements BinaryCodec<Integer> {
        ...
        @Override
        public Integer decode(ByteBuffer buffer, int length) {
            return buffer.getInt();
        }

        @Override
        public void encode(Integer value, ByteBuffer buffer) {
            buffer.putInt(value);
        }

        @Override
        public int estimateSize(Integer value) {
            return 4;
        }
    }
    ...
    record Int8Codec() implements BinaryCodec<Long> {
        ...
        @Override
        public void encode(Long value, ByteBuffer buffer) {
            buffer.putLong(value);
        }

        @Override
        public int estimateSize(Long value) {
            return 8;
        }
    }
    ...
    record Float4Codec() implements BinaryCodec<Float> {
        ...
        @Override
        public Float decode(ByteBuffer buffer, int length) {
            return buffer.getFloat();
        }

        @Override
        public void encode(Float value, ByteBuffer buffer) {
            buffer.putFloat(value);
        }

        @Override
        public int estimateSize(Float value) {
            return 4;
        }
    }
    ...
    record Float8Codec() implements BinaryCodec<Double> {
        ...
        @Override
        public Double decode(ByteBuffer buffer, int length) {
            return buffer.getDouble();
        }

        @Override
        public void encode(Double value, ByteBuffer buffer) {
            buffer.putDouble(value);
        }

        @Override
        public int estimateSize(Double value) {
            return 8;
        }
    }
    ...
    record BoolCodec() implements BinaryCodec<Boolean> {
        ...
        @Override
        public Boolean decode(ByteBuffer buffer, int length) {
            return buffer.get() != 0;
        }

        @Override
        public void encode(Boolean value, ByteBuffer buffer) {
        ...
        @Override
        public int estimateSize(Boolean value) {
            return 1;
        }
    }
    ...
    record ByteaCodec() implements BinaryCodec<byte[]> {
        ...
        @Override
        public void encode(byte[] value, ByteBuffer buffer) {
            buffer.put(value);
        }
    ...
    record UuidCodec() implements BinaryCodec<UUID> {
        ...
        @Override
        public UUID decode(ByteBuffer buffer, int length) {
            return new UUID(buffer.getLong(), buffer.getLong());
        }

        @Override
        public void encode(UUID value, ByteBuffer buffer) {
            buffer.putLong(value.getMostSignificantBits());
            buffer.putLong(value.getLeastSignificantBits());
        }

        @Override
        public int estimateSize(UUID value) {
            return 16;
        }
    }
    ...
    record DateCodec() implements BinaryCodec<LocalDate> {
        ...
        @Override
        public void encode(LocalDate value, ByteBuffer buffer) {
            buffer.putInt((int)(value.toEpochDay() - PG_EPOCH.toEpochDay()));
        }

        @Override
        public int estimateSize(LocalDate value) {
            return 4;
        }
    }
    ...
    record TimeCodec() implements BinaryCodec<LocalTime> {
        ...
        @Override
        public LocalTime decode(ByteBuffer buffer, int length) {
        ...
        @Override
        public void encode(LocalTime value, ByteBuffer buffer) {
            buffer.putLong(value.toNanoOfDay() / 1000);
        }

        @Override
        public int estimateSize(LocalTime value) {
            return 8;
        }
    }
    ...
    record TimeTzCodec() implements BinaryCodec<OffsetTime> {
        ...
        @Override
        public OffsetTime decode(ByteBuffer buffer, int length) {
            long micros = buffer.getLong();
    ...
    record TimestampCodec() implements BinaryCodec<LocalDateTime> {
        ...
        @Override
        public void encode(LocalDateTime value, ByteBuffer buffer) {
        ...
        @Override
        public int estimateSize(LocalDateTime value) {
            return 8;
        }
    }
    ...
    record TimestampTzCodec() implements BinaryCodec<Instant> {
        ...
        @Override
        public void encode(Instant value, ByteBuffer buffer) {
        ...
        @Override
        public int estimateSize(Instant value) {
            return 8;
        }
    }
}
