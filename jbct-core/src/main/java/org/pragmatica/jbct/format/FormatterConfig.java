...
public record FormatterConfig(
    ...
    public static final FormatterConfig DEFAULT = new FormatterConfig(
            ...
            4,      // indentSize
            false,  // useTabs
            true,   // alignChainedCalls
            true,   // alignArguments
            true,   // alignParameters
            true    // organizeImports
    );
    ...
    public FormatterConfig withMaxLineLength(int maxLineLength) {
        return new FormatterConfig(maxLineLength, indentSize, useTabs, alignChainedCalls,
                                   alignArguments, alignParameters, organizeImports);
    }
