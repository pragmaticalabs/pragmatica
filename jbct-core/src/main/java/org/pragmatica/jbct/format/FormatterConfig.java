...
public record FormatterConfig(int maxLineLength,
    ...
    public static FormatterConfig formatterConfig(int maxLineLength,
                                                   ...
                                                   boolean alignParameters,
                                                   boolean organizeImports) {
        return new FormatterConfig(maxLineLength, indentSize, useTabs, alignChainedCalls, alignArguments, alignParameters, organizeImports);
    }
    ...
    public FormatterConfig withMaxLineLength(int maxLineLength) {
        return formatterConfig(maxLineLength, indentSize, useTabs, alignChainedCalls, alignArguments, alignParameters, organizeImports);
    }
