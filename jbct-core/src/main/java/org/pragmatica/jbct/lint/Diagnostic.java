...
public record Diagnostic(
    ...
    public static Diagnostic diagnostic(String ruleId,
                                        ...
                                        String message,
                                        String details) {
        return new Diagnostic(ruleId, severity, file, line, column, message, details,
    ...
    public static Diagnostic diagnostic(String ruleId,
                                        ...
                                        String docLink) {
        return new Diagnostic(ruleId, severity, file, line, column, message, details,
                              Option.option(example), Option.option(docLink));
    }
    ...
    public String toHumanReadable() {
        ...
        example.onPresent(ex -> {
            sb.append("  Example:\n");
            ex.lines().forEach(l -> sb.append("    ").append(l).append("\n"));
        });

        docLink.onPresent(link -> sb.append("  See: ").append(link).append("\n"));
