...
import org.pragmatica.aether.example.urlshortener.shortener.UrlShortener;
...
@Slice public interface Analytics {
    ...
    record RecordClickResponse(String shortCode, long totalClicks, String version) {
        public static RecordClickResponse recordClickResponse(String shortCode, long totalClicks) {
            return new RecordClickResponse(shortCode, totalClicks, UrlShortener.VERSION);
        }
    }

    record GetStatsResponse(String shortCode, long clickCount, String version) {
        public static GetStatsResponse getStatsResponse(String shortCode, long clickCount) {
            return new GetStatsResponse(shortCode, clickCount, UrlShortener.VERSION);
        }
    }
