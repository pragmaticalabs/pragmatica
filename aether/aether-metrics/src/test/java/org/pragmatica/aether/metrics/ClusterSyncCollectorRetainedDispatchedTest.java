...
class ClusterSyncCollectorRetainedDispatchedTest {
    ...
    void retainedDispatched_survivesPastReadinessTtlWindow() {
        ...
        var ping = new ClusterSyncPing(LEADER,
                                       Map.of(),
                                       1L,
                                       1L,
                                       0L,
                                       Set.of(),
                                       Set.of(),
                                       Map.of(DISPATCHED_A, "READY"),
                                       Set.of(DISPATCHED_A, DISPATCHED_B),
                                       true,
                                       true);
    ...
    private record FollowerLeaderManager(NodeId leaderId) implements LeaderManager {
        ...
        @Override
        public void peerJoined(PeerJoined p) {}

        @Override
        public void peerDisconnected(PeerDisconnected p) {}

        @Override
        public void peerObservedFaulty(PeerObservedFaulty p) {}

        @Override
        public void peerReconnected(PeerReconnected p) {}

        @Override
        public void selfShutdown(SelfShutdown s) {}
