...
/// Inert `MetricsCollector` for tests that don't exercise metrics collection.
final class NoopCollector implements MetricsCollector {
    ...
    @Override public void onMetricsPing(MetricsPing ping) {}
    @Override public void onMetricsPong(MetricsPong pong) {}
    ...
    @Override public void addPongListener(Consumer<MetricsPong> listener) {}
}
