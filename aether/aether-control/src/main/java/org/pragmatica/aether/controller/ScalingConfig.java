 ...
 *
 * <p>This replaces absolute metric thresholds with relative change detection
 * using sliding windows.
 *
 * <p><strong>Note on evaluationIntervalMs:</strong> Both {@link ControllerConfig} and ScalingConfig have
 * an evaluationIntervalMs field. They serve different purposes:
 * <ul>
 *   <li>{@code ControllerConfig.evaluationIntervalMs} - Controls the scheduler interval for the control loop
 *       (how often the controller runs its evaluation cycle)</li>
 *   <li>{@code ScalingConfig.evaluationIntervalMs} - Used for window timing semantics in the Lizard Brain
 *       algorithm (determines how long until the sliding window is considered "full" for scaling decisions)</li>
 * </ul>
 *
...
public record ScalingConfig(int windowSize,
     ...
     *
     * <p>Production weights:
     * <ul>
     *   <li>CPU: 0.4 - Primary indicator of compute load</li>
     *   <li>Active Invocations: 0.4 - Primary indicator of concurrent load</li>
     *   <li>P95 Latency: 0.2 - Secondary indicator of processing delays</li>
     *   <li>Error Rate: 0.0 - Used as guard rail, not in composite</li>
     * </ul>
     *
     ...
     *
     * <p>Forge weights differ from production:
     * <ul>
     *   <li>CPU: 0.0 - Disabled because simulated nodes don't reflect real CPU</li>
     *   <li>Active Invocations: 0.6 - Primary indicator in simulation</li>
     *   <li>P95 Latency: 0.4 - Important for measuring simulated delays</li>
     *   <li>Error Rate: 0.0 - Used as guard rail, not in composite</li>
     * </ul>
     *
     * <p>Uses smaller window size (5 vs 10) for faster warm-up in testing (25s vs 50s).
     *
