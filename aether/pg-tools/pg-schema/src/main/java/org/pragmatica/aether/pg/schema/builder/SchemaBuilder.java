...
public final class SchemaBuilder {
    ...
    public static Result<Schema> applyEvent(Schema schema, SchemaEvent event) {
        return switch (event) {case SchemaEvent.TableCreated e -> Result.success(schema.withTable(Table.table(e.name(),
                                                                                                              e.schema(),
                                                                                                              e.columns(),
                                                                                                              e.constraints())));case SchemaEvent.TableDropped e -> Result.success(schema.withoutTable(e.name()));case SchemaEvent.TableRenamed e -> {
            ...
            yield table.isPresent()
                  ...
                  : SchemaErrors.tableNotFound(e.oldName(), e.span()).result();
                                                        ...
                                                        e.table(),
                                                        e.span(),
                                                        t -> Result.success(t.withColumn(e.column())));case SchemaEvent.ColumnDropped e -> applyToTable(schema,
                                                                                                                                                        e.table(),
                                                                                                                                                        e.span(),
                                                                                                                                                        t -> Result.success(t.withoutColumn(e.columnName())));case SchemaEvent.ColumnRenamed e -> applyToTable(schema,
                                                                                                                                                                                                                                                               e.table(),
                                                                                                                                                                                                                                                               e.span(),
                                                                                                                                                                                                                                                               t -> renameColumn(t,
                                                                                                                                                                                                                                                                                 e.table(),
                                                                                                                                                                                                                                                                                 e.oldName(),
                                                                                                                                                                                                                                                                                 e.newName(),
                                                                                                                                                                                                                                                                                 e.span()));case SchemaEvent.ColumnTypeChanged e -> applyToColumn(schema,
                                                                                                                                                                                                                                                                                                                                                  e.table(),
                                                                                                                                                                                                                                                                                                                                                  e.column(),
                                                                                                                                                                                                                                                                                                                                                  e.span(),
                                                                                                                                                                                                                                                                                                                                                  col -> col.withType(e.newType()));case SchemaEvent.ColumnDefaultChanged e -> applyToColumn(schema,
                                                                                                                                                                                                                                                                                                                                                                                                                                             e.table(),
                                                                                                                                                                                                                                                                                                                                                                                                                                             e.column(),
                                                                                                                                                                                                                                                                                                                                                                                                                                             e.span(),
                                                                                                                                                                                                                                                                                                                                                                                                                                             col -> e.newDefault().isPresent()
                                                                                                                                                                                                                                                                                                                                                                                                                                                   ? col.withDefault(e.newDefault().unwrap())
                                                                                                                                                                                                                                                                                                                                                                                                                                                   : col.withoutDefault());case SchemaEvent.ColumnNullabilityChanged e -> applyToColumn(schema,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        e.table(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        e.column(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        e.span(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        col -> col.withNullable(e.nullable()));case SchemaEvent.ConstraintAdded e -> applyToTable(schema,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  e.table(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  e.span(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  t -> Result.success(t.withConstraint(e.constraint())));case SchemaEvent.ConstraintDropped e -> applyToTable(schema,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              e.table(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              e.span(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              t -> Result.success(t.withoutConstraint(e.constraintName())));case SchemaEvent.IndexCreated e -> {
        ...
        }case SchemaEvent.IndexDropped e -> Result.success(schema);case SchemaEvent.SequenceCreated e -> Result.success(schema.withSequence(e.sequence()));case SchemaEvent.SequenceDropped e -> Result.success(schema.withoutSequence(e.sequenceName()));case SchemaEvent.TypeCreated e -> switch (e.type()) {case PgType.EnumType et -> Result.success(schema.withEnumType(et));case PgType.CompositeType ct -> Result.success(schema.withCompositeType(ct));case PgType.DomainType dt -> Result.success(schema.withDomainType(dt));default -> Result.success(schema);};case SchemaEvent.TypeDropped e -> Result.success(schema);case SchemaEvent.EnumValueAdded e -> {
        ...
        }case SchemaEvent.SchemaCreated e -> Result.success(schema.withSchema(e.schemaName()));case SchemaEvent.SchemaDropped e -> Result.success(schema);case SchemaEvent.ExtensionCreated e -> Result.success(schema.withExtension(e.extensionName()));case SchemaEvent.CommentSet e -> {
