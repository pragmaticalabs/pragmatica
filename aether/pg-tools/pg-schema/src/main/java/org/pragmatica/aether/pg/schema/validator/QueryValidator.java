...
public final class QueryValidator {
    ...
    private void validateQualifiedRef(String tableOrAlias, String colName, SourceSpan span,
                                       Scope scope, List<ValidationError> errors) {
    ...
    static final class Scope {
        ...
        boolean hasColumn(String colName) {
            return tables.values().stream().anyMatch(t -> t.column(colName).isPresent())
