...
public final class TypeMapper {
    ...
    private static final Map<String, JavaTypeInfo> MAPPINGS = Map.ofEntries(// Numeric
    ...
    public static Option<JavaTypeInfo> map(PgType type) {
        return switch (type) {case PgType.BuiltinType bt -> {
            ...
            yield info != null
                  ...
                  : Option.empty();
                                                                                        ...
                                                                                        "getObject",
                                                                                        Option.present(elem.typeName() + "[].class")));case PgType.EnumType _ -> Option.present(new JavaTypeInfo("String",
                                                                                                                                                                                                 "String",
                                                                                                                                                                                                 false,
                                                                                                                                                                                                 Option.empty(),
                                                                                                                                                                                                 "getString",
                                                                                                                                                                                                 Option.empty()));default -> Option.present(new JavaTypeInfo("String",
                                                                                                                                                                                                                                                             "String",
                                                                                                                                                                                                                                                             false,
                                                                                                                                                                                                                                                             Option.empty(),
                                                                                                                                                                                                                                                             "getString",
