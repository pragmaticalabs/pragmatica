...
@Contract public final class MethodNameParser {
    ...
    public record ParsedMethod(Operation operation,
    ...
    private static ColumnCondition parseOneCondition(String segment) {
        ...
        if ( operatorMatch != null) {
            var colPart = segment.substring(0,
                                            segment.length() - operatorMatch.suffix.length());
