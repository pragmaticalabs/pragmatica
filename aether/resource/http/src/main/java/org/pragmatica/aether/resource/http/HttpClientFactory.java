...
public final class HttpClientFactory implements ResourceFactory<HttpClient, HttpClientConfig> {
    @Override public Class<HttpClient> resourceType() {
        return HttpClient.class;
    }

    @Override public Class<HttpClientConfig> configType() {
        return HttpClientConfig.class;
    }

    @Override public Promise<HttpClient> provision(HttpClientConfig config) {
