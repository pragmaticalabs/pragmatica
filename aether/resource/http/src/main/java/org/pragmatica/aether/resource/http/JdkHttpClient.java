...
final class JdkHttpClient implements HttpClient {
    ...
    @Override public HttpClientConfig config() {
        return config;
    }

    @Override public Promise<HttpResult<String>> get(String path) {
        return get(path, Map.of());
    }

    @Override public Promise<HttpResult<String>> get(String path, Map<String, String> headers) {
        var builder = HttpRequest.newBuilder().uri(buildUri(path))
                                            .GET()
    ...
    @Override public Promise<HttpResult<String>> post(String path, String body) {
        return post(path, body, Map.of());
    }

    @Override public Promise<HttpResult<String>> post(String path, String body, Map<String, String> headers) {
        var builder = HttpRequest.newBuilder().uri(buildUri(path))
    ...
    @Override public Promise<HttpResult<String>> put(String path, String body) {
        return put(path, body, Map.of());
    }

    @Override public Promise<HttpResult<String>> put(String path, String body, Map<String, String> headers) {
        var builder = HttpRequest.newBuilder().uri(buildUri(path))
    ...
    @Override public Promise<HttpResult<String>> delete(String path) {
        return delete(path, Map.of());
    }

    @Override public Promise<HttpResult<String>> delete(String path, Map<String, String> headers) {
        var builder = HttpRequest.newBuilder().uri(buildUri(path))
                                            .DELETE()
                                            .timeout(requestTimeout());
        applyHeaders(builder, headers);
    ...
    @Override public Promise<HttpResult<String>> patch(String path, String body) {
        return patch(path, body, Map.of());
    }

    @Override public Promise<HttpResult<String>> patch(String path, String body, Map<String, String> headers) {
        var builder = HttpRequest.newBuilder().uri(buildUri(path))
                                            .method("PATCH",
    ...
    @Override public Promise<HttpResult<byte[]>> getBytes(String path) {
        return getBytes(path, Map.of());
    }

    @Override public Promise<HttpResult<byte[]>> getBytes(String path, Map<String, String> headers) {
        var builder = HttpRequest.newBuilder().uri(buildUri(path))
                                            .GET()
                                            .timeout(requestTimeout());
        applyHeaders(builder, headers);
    ...
    private URI buildUri(String path) {
        ...
        return fullUrl.map(url -> parseUri(url)).or(() -> parseUri(path));
    }
    ...
    @Override public <T> Promise<T> postJson(String path,
                                             Object body,
    ...
    @Override public <T> Promise<T> putJson(String path,
                                            Object body,
                                            TypeToken<T> responseType,
                                            Option<TypeToken<?>> errorType) {
    ...
    @Override public <T> Promise<T> patchJson(String path,
                                              Object body,
                                              TypeToken<T> responseType,
                                              Option<TypeToken<?>> errorType) {
    ...
    @Override public <T> Promise<T> deleteJson(String path, TypeToken<T> responseType, Option<TypeToken<?>> errorType) {
        return delete(path).flatMap(result -> parseResponse(result, responseType, errorType));
    }

    @Override public Promise<Unit> deleteJsonVoid(String path) {
    ...
    private JsonMapper createJsonMapper() {
        var jsonConfig = config.json().or(JsonConfig::jsonConfig);
        return JsonMapper.jsonMapper().withPragmaticaTypes()
