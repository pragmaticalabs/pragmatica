...
import org.pragmatica.aether.resource.db.DatabaseConnectorFactory;
...
public final class R2dbcDatabaseConnectorFactory implements DatabaseConnectorFactory {
    ...
    public Result<DatabaseConnector> create(DatabaseConnectorConfig config) {
        try{
            ...
            return DatabaseConnectorError.configurationError("Failed to create R2DBC connector: " + e.getMessage())
                                         .result();
        }
    }
