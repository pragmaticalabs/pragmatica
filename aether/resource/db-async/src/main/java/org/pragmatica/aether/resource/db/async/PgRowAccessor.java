...
final class PgRowAccessor implements RowAccessor {
    ...
    public Result<Integer> getInt(String column) {
        try {
            return option(row.getInt(column)).toResult(DatabaseConnectorError.queryFailed("getInt(" + column + ")",
    ...
    public Result<Long> getLong(String column) {
        try {
            return option(row.getLong(column)).toResult(DatabaseConnectorError.queryFailed("getLong(" + column + ")",
                                                                                           "Column value was NULL"));
        } catch (Exception e) {
    ...
    public Result<Double> getDouble(String column) {
        try {
            return option(row.getDouble(column)).toResult(DatabaseConnectorError.queryFailed("getDouble(" + column + ")",
                                                                                             "Column value was NULL"));
        } catch (Exception e) {
    ...
    public Result<Boolean> getBoolean(String column) {
        try {
            return option(row.getBoolean(column)).toResult(DatabaseConnectorError.queryFailed("getBoolean(" + column
                                                                                             + ")",
                                                                                              "Column value was NULL"));
        } catch (Exception e) {
    ...
    public <V> Result<V> getObject(String column, Class<V> type) {
        try {
            ...
            return option(value).toResult(DatabaseConnectorError.queryFailed("getObject(" + column
                                                                            + ", " + type.getSimpleName()
                                                                            + ")",
                                                                             "Column value was NULL"));
        } catch (Exception e) {
