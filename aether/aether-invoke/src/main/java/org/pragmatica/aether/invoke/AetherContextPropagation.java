 ...
 *
 * <p>This implementation captures and restores the InvocationContext (request ID)
 ...
 *
 * <p>The context snapshot captures the current request ID and restores it when
