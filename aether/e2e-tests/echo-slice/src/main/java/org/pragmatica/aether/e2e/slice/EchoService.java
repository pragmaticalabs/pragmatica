...
public interface EchoService {
    ...
    record EchoResponse(String message, long timestamp) {
        public static EchoResponse echoResponse(String message) {
            return new EchoResponse(message, System.currentTimeMillis());
        }
    }
    ...
    record PingResponse(boolean pong, String nodeId, long timestamp) {
        public static PingResponse pingResponse() {
            ...
            return new PingResponse(true, nodeId, System.currentTimeMillis());
        }
    }
    ...
    record TransformResponse(String operation, String input, String result) {
        public static TransformResponse transformResponse(String operation, String input, String result) {
            return new TransformResponse(operation, input, result);
        }
    }
