...
@Slice public interface EchoService {
    ...
    record PingResponse(boolean pong, String nodeId, long timestamp) {
        public static Result<PingResponse> pingResponse() {
            var nodeId = readNodeId();
            return success(new PingResponse(true, nodeId, System.currentTimeMillis()));
        }
    ...
    record TransformResponse(String operation, String input, String result) {
        public static Result<TransformResponse> transformResponse(String operation, String input, String result) {
            return success(new TransformResponse(operation, input, result));
        }
    }
