...
#   P1-P3  CLOUD_RESOURCES_PROVISIONED (run-tests.sh): a cluster-B-only run sets it after B's
#          bootstrap, and --keep-on-failure never reports "nothing to reap" over live VMs.
#
