...
/// decided HERE, by [AetherNode.QuicTransportCause]: the QUIC `onPeerLeft` listener reports
...
class QuicTransportCauseHintOriginTest {
    ...
    void unreachableHint_peerLeft_isLinkLostOrigin() {
        var hint = AetherNode.QuicTransportCause.PEER_LEFT.unreachableHint(PEER);
    ...
    void unreachableHint_pingTimeout_isPeerUnresponsiveOrigin() {
        var hint = AetherNode.QuicTransportCause.PING_TIMEOUT.unreachableHint(PEER);
