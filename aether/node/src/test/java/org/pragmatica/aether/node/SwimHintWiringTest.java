...
class SwimHintWiringTest {
    ...
    void pongResponsiveReporter_sendsPeerResponsiveForPongSender() {
        AetherNode.pongResponsiveReporter(SELF, hints::add).accept(new ClusterSyncPong(PEER, new MetricObservation(0L, System.nanoTime(), System.currentTimeMillis(), Map.of()), 0L, 0L, 0L, "", java.util.List.of(), java.util.List.of(), java.util.List.of(), org.pragmatica.lang.Option.none()));
    ...
    void pongResponsiveReporter_selfPong_sendsNothing() {
        AetherNode.pongResponsiveReporter(SELF, hints::add).accept(new ClusterSyncPong(SELF, new MetricObservation(0L, System.nanoTime(), System.currentTimeMillis(), Map.of()), 0L, 0L, 0L, "", java.util.List.of(), java.util.List.of(), java.util.List.of(), org.pragmatica.lang.Option.none()));
