...
public interface AetherNode extends ManageableNode {
    ...
    private static Result<AetherNode> assembleNode(AetherNodeConfig config,
        ...
        DHTNetwork dhtNetwork = new DHTNetwork() {
            ...
            public Set<NodeId> livePeers() {
                ...
                var live = Option.option(membershipFsmRef.get()).map(MembershipFsm::dhtRoutableMembers).or(() -> new HashSet<>(clusterNode.network()
                                                                                                                                          .connectedPeers()));
        ...
        // #277 PR1: write-side registry that owns the live per-slice ObservabilityAspect instances and
        // pushes KV-sourced AspectObservabilityConfig snapshots onto them. Constructed here (clusterNode +
        // kvStore are in scope) so the slice-load seam can register each aspect and the unload seam release it.
        var obsConfigRegistry = ObservabilityConfigRegistry.observabilityConfigRegistry(clusterNode, kvStore);
        var sliceStore = SliceStore.sliceStore(sliceRegistry,
                                               ...
                                               obsConfigRegistry::createAndRegister,
                                               obsConfigRegistry::deregister);
    ...
    private static void onClusterConfigPut(ValuePut<AetherKey.ClusterConfigKey, AetherValue.ClusterConfigValue> put,
                                           ...
                                           LeaderReconciler leaderReconciler) {
        clusterTopologyManager.observer().handleSetClusterSize(new TopologyManagementMessage.SetClusterSize(put.cause().value().coreCount()));
    ...
    private static List<MessageRouter.Entry<?>> collectRouteEntries(KVStore<AetherKey, AetherValue> kvStore,
                                                                    ...
                                                                    ObservabilityConfigRegistry obsConfigRegistry,
                                                                    LogLevelRegistry logLevelRegistry,
                                                                    Option<DynamicConfigManager> dynamicConfigManager,
                                                                    TTMManager ttmManager,
                                                                    RabiaMetricsCollector rabiaMetricsCollector,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 alertManager::onAlertThresholdPut).onRemove(AetherKey.AlertThresholdKey.class,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             alertManager::onAlertThresholdRemove).onPut(AetherKey.ObservabilityDepthKey.class,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         depthRegistry::onDepthPut).onRemove(AetherKey.ObservabilityDepthKey.class,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             depthRegistry::onDepthRemove).onPut(AetherKey.ObservabilityConfigKey.class,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 obsConfigRegistry::onObservabilityConfigPut).onRemove(AetherKey.ObservabilityConfigKey.class,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       obsConfigRegistry::onObservabilityConfigRemove).onPut(AetherKey.LogLevelKey.class,
