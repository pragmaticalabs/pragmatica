 ...
 */
public sealed interface InfraStoreImpl extends InfraStore {
    /**
     ...
     */
    static InfraStoreImpl infraStoreImpl() {
        return new infraStoreImpl(new ConcurrentHashMap<>(), new Object());
    }

    /**
     * Implementation record.
     */
    record infraStoreImpl(ConcurrentHashMap<String, List<VersionedInstance<?>>> store,
                          Object createLock) implements InfraStoreImpl {
