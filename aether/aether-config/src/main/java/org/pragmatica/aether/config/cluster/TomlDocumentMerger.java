...
public final class TomlDocumentMerger {
    private TomlDocumentMerger() {}

    /// Merge base with overlay. Overlay values override base for same keys.
    /// Arrays and scalars replace wholesale. Keys only in base are preserved.
    ...
    private static Map<String, Map<String, Object>> mergeSections(Map<String, Map<String, Object>> base,
        ...
        overlay.forEach((section, overlayValues) -> merged.merge(section, overlayValues,
