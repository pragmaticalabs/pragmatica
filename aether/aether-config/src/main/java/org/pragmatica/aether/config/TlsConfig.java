...
public record TlsConfig(boolean autoGenerate,
    ...
    public static TlsConfig tlsConfig(boolean autoGenerate, String certPath, String keyPath, String caPath) {
        return new TlsConfig(autoGenerate, certPath, keyPath, caPath);
    }
    ...
    public static TlsConfig withCertificates(String certPath, String keyPath, String caPath) {
        return tlsConfig(false, certPath, keyPath, caPath);
    }
