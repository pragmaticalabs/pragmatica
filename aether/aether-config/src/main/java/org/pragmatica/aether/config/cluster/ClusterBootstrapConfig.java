...
public record ClusterBootstrapConfig(
    ...
    public static ClusterBootstrapConfig clusterBootstrapConfig(String configVersion,
                                                                ...
                                                                InfrastructureConfig infrastructure,
                                                                OperationsConfig operations) {
        return new ClusterBootstrapConfig(configVersion, cluster, coreTopology, sources, runtimes,
                                          infrastructure, operations);
    }

    /// S3.3 REQ-3.3.1 — Derived core count is the sum of core sub-table sizes across all sources.
