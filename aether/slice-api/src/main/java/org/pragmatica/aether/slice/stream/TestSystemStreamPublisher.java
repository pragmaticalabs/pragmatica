...
/// exclusively via {@link FrameworkStreamPublishers#testPublisher(StreamAddress, Consumer)} so the
...
record TestSystemStreamPublisher<T>(StreamAddress address, Consumer<T> capture) implements FrameworkStreamPublisher<T> {
