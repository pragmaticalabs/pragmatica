...
public record ConsumerConfig(String groupId,
    ...
    public enum ProcessingMode { ORDERED, PARALLEL }

    /// Controls behavior when event processing fails.
    public enum ErrorStrategy { RETRY, SKIP, STALL }
    ...
    public static ConsumerConfig consumerConfig(String groupId, int maxBatchSize,
                                                ProcessingMode processingMode, ErrorStrategy errorStrategy) {
