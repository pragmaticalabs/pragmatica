...
/// @param managementMaxContentLength Optional max body size for management HTTP server (bytes). Defaults to
///                                   2 MiB. Management API is not designed for large payloads.
public record PassiveLBConfig(int httpPort,
                              ...
                              Option<Integer> managementMaxContentLength) {
