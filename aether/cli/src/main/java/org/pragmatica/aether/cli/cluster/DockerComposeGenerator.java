...
sealed interface DockerComposeGenerator {
    ...
    private static void appendNodeService(StringBuilder sb,
        ...
        sb.append("    image: ")
          .append(image)
          .append('\n');
        sb.append("    container_name: aether-")
          .append(nodeId)
          .append('\n');
        sb.append("    hostname: ")
          .append(hostname)
    ...
    private static void appendEnvironment(StringBuilder sb,
        ...
        sb.append("      NODE_ID: \"")
          .append(nodeId)
          .append("\"\n");
        sb.append("      CLUSTER_PORT: \"")
          .append(ports.cluster())
          .append("\"\n");
        sb.append("      MANAGEMENT_PORT: \"")
          .append(ports.management())
          .append("\"\n");
        sb.append("      SWIM_PORT: \"")
          .append(ports.swim())
          .append("\"\n");
        sb.append("      AETHER_CLUSTER_SECRET: \"")
          .append(clusterSecret)
          .append("\"\n");
        sb.append("      PEERS: \"")
          .append(peers)
          .append("\"\n");
    ...
    private static void appendPorts(StringBuilder sb, PortMapping ports, int index) {
        sb.append("    ports:\n");
        sb.append("      - \"")
          .append(ports.management() + index)
          .append(':')
          .append(ports.management())
          .append("\"\n");
        sb.append("      - \"")
          .append(ports.appHttp() + index)
          .append(':')
          .append(ports.appHttp())
          .append("\"\n");
        sb.append("      - \"")
          .append(ports.cluster() + index)
          .append(':')
          .append(ports.cluster())
          .append("/udp\"\n");
        sb.append("      - \"")
          .append(ports.swim() + index)
          .append(':')
          .append(ports.swim())
          .append("/udp\"\n");
    }
