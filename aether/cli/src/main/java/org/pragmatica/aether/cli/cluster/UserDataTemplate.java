...
sealed interface UserDataTemplate {
    ...
    static String render(ClusterManagementConfig config,
        ...
        var tlsEnabled = deployment.tls()
                                   .isPresent();
        var isContainer = deployment.runtime()
                                    .type() == RuntimeType.CONTAINER;
        var image = deployment.runtime()
                              .image()
                              .or("ghcr.io/pragmaticalabs/aether-node:" + cluster.version());
        var heap = deriveHeap(deployment.instances()
    ...
    private static void appendVariables(StringBuilder sb,
                                        ...
                                        boolean tlsEnabled,
                                        int coreCount) {
        sb.append("AETHER_VERSION=\"")
          .append(version)
          .append("\"\n");
        sb.append("AETHER_IMAGE=\"")
          .append(image)
          .append("\"\n");
        sb.append("AETHER_NODE_ID=\"")
          .append(nodeId)
          .append("\"\n");
        sb.append("AETHER_CLUSTER_SECRET=\"")
          .append(clusterSecret)
          .append("\"\n");
        sb.append("AETHER_CLUSTER_PORT=")
          .append(clusterPort)
          .append('\n');
        sb.append("AETHER_MANAGEMENT_PORT=")
          .append(managementPort)
          .append('\n');
        sb.append("AETHER_SWIM_PORT=")
          .append(swimPort)
          .append('\n');
        sb.append("AETHER_TLS_ENABLED=")
          .append(tlsEnabled)
          .append('\n');
        sb.append("AETHER_CORE_COUNT=")
          .append(coreCount)
          .append("\n\n");
    }
    ...
    private static void appendContainerRun(StringBuilder sb,
        ...
        sb.append("    -l aether-cluster=")
          .append(clusterName)
          .append(" \\\n");
        sb.append("    -l aether-node-id=")
          .append(nodeId)
          .append(" \\\n");
    ...
    private static void appendJvmInstall(StringBuilder sb, String version) {
        ...
        sb.append("    \"https://github.com/pragmaticalabs/aether/releases/download/v")
          .append(version)
