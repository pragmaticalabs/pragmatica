...
subcommands = {DeployCommand.ListCommand.class, DeployCommand.StatusCommand.class, DeployCommand.PromoteCommand.class, DeployCommand.RollbackCommand.class, DeployCommand.CompleteCommand.class})
@Contract public class DeployCommand implements Callable<Integer> {
    ...
    static class ListCommand implements Callable<Integer> {
        ...
        @Override public Integer call() {
            var response = deployParent.parent.fetchFromNode("/api/deployments");
