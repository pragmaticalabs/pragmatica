...
@Command(name = "cluster", description = "Cluster lifecycle management", subcommands = {ClusterBootstrapCommand.class, ClusterListCommand.class, ClusterUseCommand.class, ClusterRemoveCommand.class, ClusterStatusCommand.class, ClusterExportCommand.class, ClusterApplyCommand.class, ClusterDrainCommand.class, ClusterDestroyCommand.class, ClusterScaleCommand.class, ClusterUpgradeCommand.class, ClusterMigrateCommand.class, ClusterTasksCommand.class, ClusterTopologyCommand.class, ClusterRotateKeyCommand.class, ClusterRevokeKeyCommand.class, ClusterListKeysCommand.class}) @Contract public class ClusterCommand implements Runnable {
