...
class DockerComposeTemplateTest {
    ...
    void renderEmitsClusterLabelOnEveryNode() {
        var rendered = DockerComposeTemplate.render("us-prod", 5, "aether-node:latest", 5150, 8070, 6000);
    ...
    void renderEmitsNodeIdLabelForEveryNode() {
        var rendered = DockerComposeTemplate.render("staging", 3, "aether-node:latest", 5150, 8070, 6000);
    ...
    void renderEmitsClusterScopedNetwork() {
        var rendered = DockerComposeTemplate.render("us-east", 3, "aether-node:latest", 5150, 8070, 6000);
        assertThat(rendered).contains("aether-us-east-network");
    }

    @Test
    void renderEmitsPeerListUsingClusterName() {
        var rendered = DockerComposeTemplate.render("eu", 3, "aether-node:latest", 5150, 8070, 6000);
    ...
    void renderHonoursPortBases() {
        var rendered = DockerComposeTemplate.render("c", 3, "aether-node:latest", 6000, 9000, 7000);
    ...
    void renderEmitsRestartNoComment() {
        var rendered = DockerComposeTemplate.render("c", 3, "aether-node:latest", 5150, 8070, 6000);
