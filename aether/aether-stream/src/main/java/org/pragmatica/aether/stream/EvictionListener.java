...
/// Takes the events a ring is about to reclaim (#1234) — only those at or below the ring's visible position;
/// an evictee above it is dropped and reported to the [UnacknowledgedEvictionListener] instead (#1352). Success
/// means the listener now owns them — the ring
