...
public interface ReplicationManager {
    ...
    private static ReplicationManager noOpReplicationManager() {
        ...
        return new ReplicationManager() {@Contract@Override public void replicateEvent(String streamName, int partition, long offset, byte[] payload, long timestamp) {}@Contract@Override public void handleAck(ReplicationMessage.ReplicateAck ack) {}@Override public ReplicaRegistry registry() {
