...
public record SealedSegment(String streamName, int partition, long startOffset, long endOffset,
                            int eventCount, long minTimestamp, long maxTimestamp, byte[] serializedEvents) {
    ...
    public static SealedSegment sealedSegment(String streamName, int partition, long startOffset, long endOffset,
                                              int eventCount, long minTimestamp, long maxTimestamp,
                                              byte[] serializedEvents) {
        return new SealedSegment(streamName, partition, startOffset, endOffset,
                                eventCount, minTimestamp, maxTimestamp, serializedEvents);
    }
