...
public interface RowMapper<T> {
     ...
     * <ul>
     *   <li>Extract values from the row by column name or index</li>
     *   <li>Return failure for missing required fields</li>
     *   <li>Handle type conversion errors gracefully</li>
     * </ul>
     *
