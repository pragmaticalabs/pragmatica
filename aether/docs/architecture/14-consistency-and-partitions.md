...
| **Stream consume** (`stream.consume`) | Per-partition order; **at-least-once** (cursor checkpoints periodically, un-checkpointed window redelivered) | Owner side; RF=1: empty after failover | LIVE · guarantees.md §4 |
