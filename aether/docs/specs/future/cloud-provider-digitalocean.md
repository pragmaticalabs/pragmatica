...
> ⚠️ **Design only — not implemented in the 1.0.0 line.** This is a design specification with no shipped implementation. DigitalOcean is not among the 1.0.0 line's supported cloud providers (AWS, Azure, GCP, Hetzner) — do not use this document as a reference for what currently-shipping Aether supports.
