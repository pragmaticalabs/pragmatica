...
public enum ManagementRoute {
    ...
    STREAM_LIST(GET, "/api/streams", List.of(), ANY),
    STREAM_GET(GET, "/api/streams", List.of("streamName"), ANY),
    STREAM_PARTITION(GET, "/api/streams", List.of("streamName", "partition"), ANY),
    STREAM_PUBLISH(POST, "/api/streams/publish", List.of("streamName"), taskGroup(STREAMING)),
    STREAM_READ(GET, "/api/streams/read", List.of("streamName", "partition"), ANY),
