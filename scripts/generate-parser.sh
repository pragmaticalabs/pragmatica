...
PEGLIB_JAR="$HOME/.m2/repository/org/pragmatica-lite/peglib/0.1.4/peglib-0.1.4.jar"
CORE_JAR="$HOME/.m2/repository/org/pragmatica-lite/core/0.8.6/core-0.8.6.jar"
