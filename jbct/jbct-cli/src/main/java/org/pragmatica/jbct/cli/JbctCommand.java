...
@Command(name = "jbct", description = "JBCT code formatting and linting tool", mixinStandardHelpOptions = true, versionProvider = JbctCommand.VersionProvider.class, subcommands = {FormatCommand.class, LintCommand.class, CheckCommand.class, CheckSheetCommand.class, ScoreCommand.class, DocCommand.class, UpgradeCommand.class, InitCommand.class, AddSliceCommand.class, AddEventCommand.class, AddPersistenceCommand.class, FixSliceCommand.class, UpdateCommand.class, MigrateCommand.class, VerifySliceCommand.class})
