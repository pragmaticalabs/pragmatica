...
public class CstParsingUtilitiesRule implements CstLintRule {
    ...
    new ParsingPattern("Integer\\.parseInt", "Number.parseInt", "org.pragmatica.lang.utils.Number"),
                                                                 new ParsingPattern("Integer\\.parseUnsignedInt",
                                                                                    "Number.parseInt",
                                                                                    "org.pragmatica.lang.utils.Number"),
                                                                 new ParsingPattern("Long\\.parseLong",
                                                                                    "Number.parseLong",
                                                                                    "org.pragmatica.lang.utils.Number"),
                                                                 new ParsingPattern("Long\\.parseUnsignedLong",
                                                                                    "Number.parseLong",
                                                                                    "org.pragmatica.lang.utils.Number"),
                                                                 new ParsingPattern("Short\\.parseShort",
                                                                                    "Number.parseShort",
                                                                                    "org.pragmatica.lang.utils.Number"),
                                                                 new ParsingPattern("Byte\\.parseByte",
                                                                                    "Number.parseByte",
                                                                                    "org.pragmatica.lang.utils.Number"),
                                                                 new ParsingPattern("Float\\.parseFloat",
                                                                                    "Number.parseFloat",
                                                                                    "org.pragmatica.lang.utils.Number"),
                                                                 new ParsingPattern("Double\\.parseDouble",
                                                                                    "Number.parseDouble",
                                                                                    "org.pragmatica.lang.utils.Number"),
                                                                 new ParsingPattern("new BigInteger\\s*\\(",
                                                                                    "Number.parseBigInteger",
                                                                                    "org.pragmatica.lang.utils.Number"),
                                                                 new ParsingPattern("new BigDecimal\\s*\\(",
                                                                                    "Number.parseBigDecimal",
                                                                                    "org.pragmatica.lang.utils.Number"),

    // Text/Pattern parsing
    new ParsingPattern("Enum\\.valueOf", "Text.parseEnum", "org.pragmatica.lang.utils.Text"),
                                                                 new ParsingPattern("Pattern\\.compile",
                                                                                    "Text.compilePattern",
                                                                                    "org.pragmatica.lang.utils.Text"),
                                                                 new ParsingPattern("Base64\\.getDecoder\\(\\)\\.decode",
                                                                                    "Text.decodeBase64",
                                                                                    "org.pragmatica.lang.utils.Text"),
                                                                 new ParsingPattern("Base64\\.getUrlDecoder\\(\\)\\.decode",
    ...
    new ParsingPattern("LocalDate\\.parse", "DateTime.parseLocalDate", "org.pragmatica.lang.utils.DateTime"),
                                                                 new ParsingPattern("LocalTime\\.parse",
                                                                                    "DateTime.parseLocalTime",
                                                                                    "org.pragmatica.lang.utils.DateTime"),
                                                                 new ParsingPattern("LocalDateTime\\.parse",
                                                                                    "DateTime.parseLocalDateTime",
                                                                                    "org.pragmatica.lang.utils.DateTime"),
                                                                 new ParsingPattern("ZonedDateTime\\.parse",
                                                                                    "DateTime.parseZonedDateTime",
                                                                                    "org.pragmatica.lang.utils.DateTime"),
                                                                 new ParsingPattern("OffsetDateTime\\.parse",
                                                                                    "DateTime.parseOffsetDateTime",
                                                                                    "org.pragmatica.lang.utils.DateTime"),
                                                                 new ParsingPattern("OffsetTime\\.parse",
                                                                                    "DateTime.parseOffsetTime",
                                                                                    "org.pragmatica.lang.utils.DateTime"),
                                                                 new ParsingPattern("Instant\\.parse",
                                                                                    "DateTime.parseInstant",
                                                                                    "org.pragmatica.lang.utils.DateTime"),
                                                                 new ParsingPattern("Duration\\.parse",
                                                                                    "DateTime.parseDuration",
                                                                                    "org.pragmatica.lang.utils.DateTime"),
                                                                 new ParsingPattern("Period\\.parse",
    ...
    new ParsingPattern("new URL\\s*\\(", "Network.parseURL", "org.pragmatica.lang.utils.Network"),
                                                                 new ParsingPattern("URI\\.create",
                                                                                    "Network.parseURI",
                                                                                    "org.pragmatica.lang.utils.Network"),
                                                                 new ParsingPattern("new URI\\s*\\(",
                                                                                    "Network.parseURI",
                                                                                    "org.pragmatica.lang.utils.Network"),
                                                                 new ParsingPattern("UUID\\.fromString",
                                                                                    "Network.parseUUID",
                                                                                    "org.pragmatica.lang.utils.Network"),
                                                                 new ParsingPattern("InetAddress\\.getByName",
                                                                                    "Network.parseInetAddress",
                                                                                    "org.pragmatica.lang.utils.Network"),

    // I18n parsing
    new ParsingPattern("Currency\\.getInstance", "I18n.parseCurrency", "org.pragmatica.lang.utils.I18n"),
                                                                 new ParsingPattern("Locale\\.forLanguageTag",
                                                                                    "I18n.parseLocale",
                                                                                    "org.pragmatica.lang.utils.I18n"),
                                                                 new ParsingPattern("Charset\\.forName",
                                                                                    "I18n.parseCharset",
                                                                                    "org.pragmatica.lang.utils.I18n"),
                                                                 new ParsingPattern("ZoneId\\.of\\s*\\(",
                                                                                    "I18n.parseZoneId",
                                                                                    "org.pragmatica.lang.utils.I18n"),
                                                                 new ParsingPattern("ZoneOffset\\.of\\s*\\(",
    ...
    static {
        var patternStrings = PATTERNS.stream().map(p -> "(" + p.jdkPattern() + ")").toList();
