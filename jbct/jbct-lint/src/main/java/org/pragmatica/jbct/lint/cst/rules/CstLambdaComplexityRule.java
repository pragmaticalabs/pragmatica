...
public class CstLambdaComplexityRule implements CstLintRule {
    ...
    private boolean hasControlFlow(String lambdaText) {
        return lambdaText.contains("if ") || lambdaText.contains("if(") || lambdaText.contains("switch ") || lambdaText.contains("switch(") || lambdaText.contains("try ") || lambdaText.contains("try{");
    }
