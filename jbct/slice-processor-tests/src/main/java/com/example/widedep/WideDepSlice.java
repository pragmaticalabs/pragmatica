...
public interface WideDepSlice {
    ...
    static WideDepSlice wideDepSlice() {
        return new WideDepSlice() {
            @Override
            public Promise<Pong> m01(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m02(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m03(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m04(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m05(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m06(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m07(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m08(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m09(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m10(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m11(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m12(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m13(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m14(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m15(Ping request) {
                return echo(request);
            }

            @Override
            public Promise<Pong> m16(Ping request) {
                return echo(request);
            }
